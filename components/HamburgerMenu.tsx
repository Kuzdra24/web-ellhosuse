      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`fixed inset-0 bg-white flex flex-col items-center justify-center p-6 space-y-6 menu-container transition-all 
              ${isOpen ? "pointer-events-auto h-screen w-screen" : "pointer-events-none h-0 w-0"}`}
          >
            <div className="mb-6">
